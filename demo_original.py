        ...
        while True:
            ...
            if faces is not None:
                for box, landmarks, score in faces:
                    ...
                    img = Variable(img).cuda(gpu) #Varibale에는 3가지 속성이 있습니다:data:Tensor가 저장되어 있습니다.grad : data의 기울기를 저장했습니다.grad_fn: Function 개체를 가리키며, 역방향 전파의 기울기를 계산합니다.
                    img = img.unsqueeze(0) #unsqueeze는 주로 차원 상승 작용을 하며, 후속 이미지 처리는 배치 조작을 더 잘 할 수 있습니다.

                    # gaze prediction
                    gaze_pitch, gaze_yaw = model(img) #특징을 얻습니다.
                    ...
                    #각 확률에 해당 클래스를 곱하고 합산하여 기대치를 얻습니다.
